...
//var WriteHead=1;
document.write('<iframe style="position:absolute;width:206px;display:none; z-index: 999;" name="divCalendar" id="divCalendar" frameborder="0" scrolling="no"></iframe>')
/*头部信息CSS及JS函数*/
...
'#msgbox {width:204px;background:#E0E0E0;text-align:center;font-size:12px;line-height:18px;color:red;border-bottom:1px solid #000;}'+
...
'ipt><div style="border:1px solid #6A84C8;height:'+(82+21*Trn)+'px;"><ul><li style="background:#FFF;"></li>'+
...
'</ul></div>'+
'<div id="msgbox">双击编辑框可自由编辑日期</div>'+
'<div id="Title"><ul><li style="color:#F00;">日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li style="color:#06F;">六</li></ul></div>'+
...
content+=((i+start)%7==1)?' style="color:#F00;"':'';
content+=((i+start)%7==0)?' style="color:#06F;"':'';
content+='>'+PrNum+'</a></li>';
PrNum++;
}
content+='</ul></div>';
...
Calendar.style.height=84+21*Trn+'px';		//框架高度
