    ...
    e.prototype = {
        _init: function() {
            ...
            b.$element.find(".pogoSlider-slide").each(function() {
                var c = [],
                e = 0;
                a(this).data("original-styles", a(this).attr("style")),
                a(this).find(".pogoSlider-slide-element").each(function() {
            ...
            b.slides[0].$element.css("opacity", 1),
            b.settings.autoplay && b.settings.displayProgess && b._createProgessBar(),
            b.$element.css("padding-bottom", 100 / (b.settings.targetWidth / b.settings.targetHeight) + "%");
            var c = b.$element.find("img").length;
            if (c > 0) {
                var e = 0;
                b.$element.prepend('<div class="pogoSlider-loading"><div class="pogoSlider-loading-icon"></div></div>'),
                b.$element.find("img").one("load",
                function() {++e === c && (a(".pogoSlider-loading").remove(), b._onSliderReady())
                }).each(function() {
        ...
        _onSliderReady: function() {
            var c = this;
            c.settings.autoplay && (c.slideStartTime = new Date, c.slideTimeRemaining = c.slides[0].totalSlideDuration, c._slideTimeout(c.slideTimeRemaining)),
            c.settings.generateButtons && c.slides.length > 1 && c._createDirButtons(),
            c.settings.generateNav && c.slides.length > 1 && c._createNavigation(),
            c.settings.preserveTargetSize && (c._preserveTargetSize(), c.settings.responsive && a(b).on("resize",
            function() {
                c._preserveTargetSize()
            })),
            c.settings.pauseOnHover && (c.$element.on("mouseenter",
            function() {
                c.pause()
            }), c.$element.on("mouseleave",
            function() {
                c.resume()
            })),
            c._onSlideStart(0)
        ...
        _createDirButtons: function() {
            var b = this;
            b.$element.addClass("pogoSlider--dir" + b.settings.buttonPosition),
            a('<button class="pogoSlider-dir-btn pogoSlider-dir-btn--prev"></button>').appendTo(b.$element).on("click",
            function() {
                b.prevSlide()
            }),
            a('<button class="pogoSlider-dir-btn pogoSlider-dir-btn--next"></button>').appendTo(b.$element).on("click",
            function() {
                b.nextSlide()
            })
        },
        _createNavigation: function() {
            ...
            for (var c = a('<ul class="pogoSlider-nav"></ul>').appendTo(b.$element), d = 0; d < b.slides.length; d++) a('<li data-num="' + d + '"><button class="pogoSlider-nav-btn"></button></li>').appendTo(c).hover(function(){
        ...
        _preserveTargetSize: function() {
            ...
            f = new RegExp("px", "i"),
            g = 1;
            g = this.scaledBy ? this.$element.width() / this.settings.targetWidth / this.scaledBy: this.$element.width() / this.settings.targetWidth,
        ...
        _createProgessBar: function() {
            ...
            a += '<div class="pogoSlider-progressBar-duration"></div>',
            a += "</div>";
        ...
        pause: function() {
            if (this.settings.autoplay) {
                ...
                this.settings.displayProgess && this.$element.find(".pogoSlider-progressBar-duration").stop(!0),
        ...
        resume: function() {
            if (this.settings.autoplay) {
                ...
                this.slideTimeRemaining, "linear"), this._slideTimeout(this.slideTimeRemaining)),
                this.settings.onSliderResume && this.settings.onSliderResume.apply(this)
            }
        },
        nextSlide: function() {
        ...
        destroy: function() {
            this.paused = !0,
            clearTimeout(this.slideTimeoutId),
            a.removeData(this.element, "plugin_" + h)
        },
        _changeToNext: function() {
            this.prevSlideIndex = this.currentSlideIndex,
            ++this.currentSlideIndex > this.numSlides - 1 && (this.currentSlideIndex = 0),
            this._changeSlide(this.prevSlideIndex, this.currentSlideIndex)
        },
        _changeSlide: function(a, b) {
            ...
            d._onSlideEnd(a),
            d.navigating = !0,
            c = g.animation && g.transition && g.transform ? d.slideTransitions: d.compatSlideTransitions;
            ...
            setTimeout(function() {
                ...
                d.navigating = !1,
                d._slideCleanup(a, !1),
                d._slideElementCleanup(a),
                d.settings.autoplay && d._slideTimeout(d.slides[b].totalSlideDuration),
                d._onSlideStart(b)
            },
            d.slides[b].duration)
        },
        _onSlideStart: function(a) {
            ...
            this.settings.generateNav && (this.$element.find(".pogoSlider-nav-btn").removeClass("pogoSlider-nav-btn--selected"), this.$element.find(".pogoSlider-nav-btn").eq(a).addClass("pogoSlider-nav-btn--selected")),
        ...
        _onSlideEnd: function(a) {
            ...
            this.slides[a].children.length > 0 && b > this.slides[a].elementTransitionDuration && this._slideElementsTransitionOut(a),
        ...
        _slideCleanup: function(a, b) {
            this.slides[a].$element.find(".pogoSlider-slide-slice").length > 0 && this._removeSlideSlices(a),
            this.slides[a].$element.attr("style", this.slides[a].$element.data("original-styles")).css("opacity", b ? "1": "0")
        },
        ...
        _createSlideSlices: function(a, b, c) {
            ...
            j.children().wrapAll('<div class="pogoSlider-slide-slice" style="width:' + f + "%;height:" + g + '%;top:0%;left:0%;"/>').wrapAll('<div class="pogoSlider-slide-slice-inner" style="' + k + "width:" + h + "%;height:" + i + '%;top:0%;left:0%;"/>'),
            j.attr("style",
            function(a, b) {
        ...
        _removeSlideSlices: function(a) {
            ...
            c.attr("style", c.data("original-styles")),
            c.find(".pogoSlider-slide-slice").not(":first").remove(),
            c.find(".pogoSlider-slide-slice-inner").children().unwrap(),
            c.find(".pogoSlider-slide-slice").children().unwrap()
        },
        ...
        slideTransitions: {
            ...
            slide: function(a, b) {
                var c;
                return c = 0 === b && a === this.slides.length - 1 ? "slideLeft": 0 === a && b === this.slides.length - 1 ? "slideRight": b > a ? "slideLeft": "slideRight",
                this.slideTransitions[c].apply(this, [a, b])
            },
            verticalSlide: function(a, b) {
                var c;
                return c = 0 === b && a === this.slides.length - 1 ? "slideUp": 0 === a && b === this.slides.length - 1 ? "slideDown": b > a ? "slideUp": "slideDown",
                this.slideTransitions[c].apply(this, [a, b])
            },
            slideLeft: function(a, b) {
                var c = this,
                d = c.slides[b];
                return c.slides[a].$element.precss("animation-duration", d.duration + "ms").addClass("pogoSlider-animation-leftOut"),
                d.$element.precss({
                    "*opacity": "1",
                ...
                function() {
                    ...
                    d.$element.attr("style", d.$element.data("original-styles")).css("opacity", "1").removeClass("pogoSlider-animation-leftIn")
                }
            },
            slideRight: function(a, b) {
                var c = this,
                d = c.slides[b];
                return c.slides[a].$element.precss("animation-duration", d.duration + "ms").addClass("pogoSlider-animation-rightOut"),
                d.$element.precss({
                    "*opacity": "1",
                    "animation-duration": d.duration + "ms"
                ...
                function() {
                    ...
                    d.$element.attr("style", d.$element.data("original-styles")).css("opacity", "1").removeClass("pogoSlider-animation-rightIn")
                }
            },
            slideUp: function(a, b) {
                ...
                function() {
                    c.slides[a].$element.removeClass("pogoSlider-animation-upOut"),
                    d.$element.attr("style", d.$element.data("original-styles")).css("opacity", "1").removeClass("pogoSlider-animation-upIn")
                }
            },
            slideDown: function(a, b) {
                var c = this,
                d = c.slides[b];
                return c.slides[a].$element.precss("animation-duration", d.duration + "ms").addClass("pogoSlider-animation-downOut"),
                d.$element.precss({
                    "*opacity": "1",
                    "animation-duration": d.duration + "ms"
                }).addClass("pogoSlider-animation-downIn"),
                function() {
                    c.slides[a].$element.removeClass("pogoSlider-animation-downOut"),
                    d.$element.attr("style", d.$element.data("original-styles")).css("opacity", "1").removeClass("pogoSlider-animation-downIn")
                }
            },
            ...
            expandReveal: function(a, b) {
                var c = this,
                d = c.slides[b];
                return c.$element.css("overflow", "visible"),
                c.slides[a].$element.precss({
                    "*z-index": c.settings.baseZindex + 1,
                    "animation-duration": d.duration + "ms"
                ...
                function() {
                    c.$element.css("overflow", ""),
                    c.slides[a].$element.removeClass("pogoSlider-animation-expandReveal")
                }
            },
            ...
            verticalSplitReveal: function(a, b) {
                var c = this,
                d = c.slides[b];
                c.slides[a].$element.css("z-index", c.settings.baseZindex + 1),
                d.$element.css({
                    opacity: 1,
                    "z-index": c.settings.baseZindex
                }),
                ...
                e.precss("animation-duration", d.duration + "ms"),
                e.eq(0).addClass("pogoSlider-animation-leftOut"),
                e.eq(1).addClass("pogoSlider-animation-rightOut")
            },
            horizontalSplitReveal: function(a, b) {
                ...
                var e = c.slides[a].$element.find(".pogoSlider-slide-slice");
                e.precss("animation-duration", d.duration + "ms"),
                e.eq(0).addClass("pogoSlider-animation-upOut"),
                e.eq(1).addClass("pogoSlider-animation-downOut")
            },
            zipReveal: function(b, c) {
                var d = this,
                e = d.slides[c];
                d.slides[b].$element.css("z-index", d.settings.baseZindex + 1),
                e.$element.css({
                    opacity: 1,
                ...
                f.precss("animation-duration", e.duration + "ms"),
                f.each(function(b) {
            ...
            barReveal: function(b, c, d) {
                var e = this,
                f = e.slides[c];
                e.slides[b].$element.css("z-index", e.settings.baseZindex + 1),
                f.$element.css({
                    opacity: 1,
                ...
                i = 2 * h;
                g.precss("animation-duration", i + "ms"),
                g.each(function(b) {
            ...
            fold: function(a, b) {
                var c;
                return c = 0 === b && a === this.slides.length - 1 ? "foldLeft": 0 === a && b === this.slides.length - 1 ? "foldRight": b > a ? "foldLeft": "foldRight",
                this.slideTransitions[c].apply(this, [a, b])
            },
            foldRight: function(a, b) {
                ...
                d = c.slides[b],
                e = c.slides[a];
                c.$element.css("overflow", "visible"),
                e.$element.css({
                    overflow: "visible",
                    "z-index": c.settings.baseZindex
                }),
                ...
                i = g.eq(0),
                j = g.eq(1);
                return d.$element.prepend(h.detach()),
                e.$element.prepend(i.detach()),
                h.addClass("pogoSlider-animation-foldInRight").precss("animation-duration", d.duration + "ms"),
                j.addClass("pogoSlider-animation-foldOutRight").precss("animation-duration", d.duration + "ms"),
                function() {
                    c.$element.css("overflow", ""),
                    d.$element.prepend(i.detach()),
                    e.$element.prepend(h.detach()),
                    c._slideCleanup(b, !0)
                }
            },
            foldLeft: function(a, b) {
                ...
                i = g.eq(0),
                j = g.eq(1);
                return d.$element.append(h.detach()),
                e.$element.append(j.detach()),
                h.addClass("pogoSlider-animation-foldInLeft").precss("animation-duration", d.duration + "ms"),
                i.addClass("pogoSlider-animation-foldOutLeft").precss("animation-duration", d.duration + "ms"),
                function() {
                    c.$element.css("overflow", ""),
                    c._slideCleanup(b, !0)
                }
        ...
        compatSlideTransitions: {
            ...
            slide: function(a, b) {
                var c;
                return c = a > b && a === this.slides.length - 1 && 0 === b ? "slideLeft": b > a && 0 === a && b === this.slides.length - 1 ? "slideRight": b > a ? "slideLeft": "slideRight",
                this.slideTransitions[c].apply(this, [a, b])
            },
            verticalSlide: function(a, b) {
                var c;
                return c = a > b && a === this.slides.length - 1 && 0 === b ? "slideUp": b > a && 0 === a && b === this.slides.length - 1 ? "slideDown": b > a ? "slideUp": "slideDown",
                this.slideTransitions[c].apply(this, [a, b])
            },
            slideLeft: function(a, b) {
                var c = this.slides[b];
